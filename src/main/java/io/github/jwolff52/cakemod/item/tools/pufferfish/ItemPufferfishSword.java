...
package io.github.jwolff52.cakemod.item.tools.pufferfish;
...
public class ItemPufferfishSword extends ItemSword{
	
	public ItemPufferfishSword(){
		super(ToolMaterial.GOLD);
		this.setUnlocalizedName("pufferfishSword");
